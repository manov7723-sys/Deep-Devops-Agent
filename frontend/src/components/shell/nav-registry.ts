...
export const NAV: Record<LayoutArea, NavEntry[]> = {
  ...
  project: [
    ...
    { kind: "link", id: "workloads", label: "Workloads", icon: "scale", hrefSegment: "workloads" },
    { kind: "link", id: "deployments", label: "Deployments", icon: "rocket", hrefSegment: "deployments" },
    { kind: "link", id: "promotions", label: "Promotions", icon: "branch", hrefSegment: "promotions" },
    { kind: "section", label: "Automation" },
    { kind: "link", id: "automation", label: "Automation", icon: "zap", hrefSegment: "automation" },
    ...
    { kind: "link", id: "secrets", label: "Secrets", icon: "lock", hrefSegment: "secrets" },
