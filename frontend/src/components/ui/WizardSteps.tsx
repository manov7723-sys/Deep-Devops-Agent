...
export function WizardSteps({ steps, current }: WizardStepsProps) {
  return (
    <div className="row" style={{ marginBottom: 22, alignItems: "center" }} role="progressbar"
      aria-valuemin={1}
    ...
    >
      {steps.map((label, i) => {
        ...
        return (
          <div key={label} className="row" style={{ flex: i < steps.length - 1 ? 1 : "none", alignItems: "center" }}>
