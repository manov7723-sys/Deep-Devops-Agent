...
const STEPS: Step[] = [
  ...
  {
    page: 1, kind: "text", key: "publicAccessCidrs", label: "Public access CIDRs", mono: true,
  ...
  // ── Page 2 · Security & tags ─────────────────────────────────────────
  {
    page: 2, kind: "text", key: "environment", label: "Environment tag", placeholder: "production", default: () => "production",
  },
  { page: 2, kind: "text", key: "team", label: "Team tag", placeholder: "devops", default: () => "devops" },
  { page: 2, kind: "text", key: "costCenter", label: "Cost center tag", optional: true, placeholder: "CC-1234" },
  {
    page: 2, kind: "choice", key: "controlPlaneLogs", label: "Control-plane logging",
  ...
  {
    page: 2, kind: "choice", key: "secretsEncryption", label: "Secrets encryption (KMS)",
    hint: "Encrypts Kubernetes secrets at rest with a dedicated KMS key.",
    choices: [{ value: true, label: "Enabled (recommended)" }, { value: false, label: "Disabled" }],
  },
  {
    page: 2, kind: "choice", key: "ebsCsi", label: "EBS CSI driver add-on",
  ...
  {
    page: 3, kind: "choice", key: "appNodeGroup", label: "Application node group",
  ...
  {
    page: 3, kind: "multiselect", key: "appInstanceTypes", label: "App node instance types",
  ...
  {
    page: 3, kind: "choice", key: "appCapacityType", label: "App capacity type",
    skip: (a) => a.appNodeGroup !== true,
  ...
  {
    page: 3, kind: "number", key: "appDesiredNodes", label: "App desired nodes", default: () => "3",
    skip: (a) => a.appNodeGroup !== true,
  },
  // ── Page 4 · Networking & repository ─────────────────────────────────
  {
    page: 4, kind: "choice", key: "createVpc", label: "Networking",
    choices: [{ value: true, label: "Create a new VPC" }, { value: false, label: "Reuse an existing VPC" }],
  },
  {
    page: 4, kind: "select", key: "existingVpcId", label: "Existing VPC",
  ...
  {
    page: 4, kind: "multiselect", key: "existingSubnetIds", label: "Subnets", optional: true,
    hint: "Pick ≥2 across different AZs. Leave empty to auto-discover the VPC's subnets.",
  ...
  {
    page: 4, kind: "select", key: "repoFullName", label: "GitHub repository",
  ...
  {
    page: 4, kind: "text", key: "ghPath", label: "GitHub file path (folder)",
...
const EKS_CONFIG: ClusterChatConfig = {
  ...
  branchPrefix: "eks",
  applyEta: "~15–20 min",
  pageTitles: ["Cluster basics", "Security & tags", "Node groups", "Networking & repository"],
