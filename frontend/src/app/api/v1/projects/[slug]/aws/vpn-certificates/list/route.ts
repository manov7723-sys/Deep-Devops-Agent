...
/**
 * GET /projects/[slug]/aws/vpn-certificates/list
 *
 * Lists every VPN certificate set approval in this project (stack prefix
 * `vpn-certs-`). Same dedupe-by-stack pattern as the Client VPN list:
 * retries create fresh approvals, but they all point at the same S3
 * state, so we surface only the newest per stack.
 */
