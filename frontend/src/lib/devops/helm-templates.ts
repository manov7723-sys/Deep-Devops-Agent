...
export const HELM_FIELDS: ManifestField[] = [
  { name: "name", label: "Chart / app name", type: "text", required: true, placeholder: "my-app", hint: "Lowercase letters, digits, hyphens." },
  { name: "description", label: "Description", type: "text", default: "A Helm chart for Kubernetes", hint: "Shown in Chart.yaml." },
  { name: "appVersion", label: "App version", type: "text", default: "1.0.0", hint: "The version of the app this chart deploys." },
  { name: "image", label: "Container image repository", type: "text", required: true, placeholder: "ghcr.io/org/app", hint: "Without the tag." },
  { name: "tag", label: "Image tag", type: "text", default: "latest", hint: "e.g. a commit SHA or semver." },
  { name: "imageDigest", label: "Image digest (optional)", type: "text", placeholder: "sha256:…", hint: "If set, the image is pinned by digest instead of tag (recommended for prod)." },
  { name: "replicaCount", label: "Replicas", type: "number", default: "2" },
  { name: "containerPort", label: "Container port", type: "number", default: "8080", hint: "Port your app listens on." },
  { name: "serviceType", label: "Service type", type: "select", default: "ClusterIP", options: ["ClusterIP", "NodePort", "LoadBalancer"] },
  ...
  { name: "probePath", label: "Health probe path", type: "text", default: "/healthz", hint: "HTTP path for liveness/readiness/startup." },
  ...
  { name: "ingressClassName", label: "Ingress class", type: "text", default: "nginx", hint: "Used when Ingress is enabled." },
  { name: "ingressHost", label: "Ingress host", type: "text", placeholder: "app.example.com", hint: "Used when Ingress is enabled." },
  { name: "ingressPath", label: "Ingress path", type: "text", default: "/" },
  { name: "ingressTls", label: "Ingress TLS", type: "toggle", default: "false", hint: "Adds a TLS block (secret <name>-tls)." },
  { name: "autoscalingEnabled", label: "Enable autoscaling (HPA)", type: "toggle", default: "false" },
  ...
  { name: "networkPolicyEnabled", label: "NetworkPolicy (default-deny)", type: "toggle", default: "false" },
  { name: "serviceMonitorEnabled", label: "Prometheus ServiceMonitor", type: "toggle", default: "false" },
  { name: "prometheusRuleEnabled", label: "Prometheus alert rules", type: "toggle", default: "false" },
];
